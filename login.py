...
<html>
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
			...
			<h2 class="text-center" style="color:darkred;font-weight:bold;">Login Panel</h2>
			<hr>
			<form action="logincode.py" method="post">
			<table style="margin:0px auto;border:1px solid;width:50%;height:200px;background-color:">
				<tr>
					<td>Enter User Id :</td>
