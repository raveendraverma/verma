...
<html>
	<head>
		...
		{
		alert("Entered Password is not confirm");
		return false;
		}
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
			...
			<h2 class="text-center" style="color:darkred;font-weight:bold;">Registration Form</h2>
			<hr>
			<form action="regcode.py" method="post" onsubmit="return confirmpassword()">
			<table style="margin:0px auto;border:1px solid;width:50%;height:400px;background-color:">
				<tr>
				...
				<tr>
					...
					<td><input type="number" name="mobileno" class="form-control" required /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="password" name="cpass" id="cpass" class="form-control" required /></td>
				</tr>
